...
public sealed class CredentialsReadToolTests
{
    ...
    #region Credentials_List_Targets tests
    ...
    public async Task CredentialListTargets_ReturnsTypedRecords()
    {
        ...
        List<CredentialsReadTool.CredentialTargetRecord> records =
            Assert.IsType<List<CredentialsReadTool.CredentialTargetRecord>>(result.Results);
